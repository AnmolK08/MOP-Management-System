                ...
                <div className="overflow-y-auto p-4 sm:p-6 space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg">
                            ...
                            <span className={`inline-block mt-1 px-2 py-1 rounded-full text-xs font-medium ${getStatusClass(order.status)}`}>
                                {order.status}
                            </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg">
                            ...
                            <p className="font-medium mt-1">{order.paid ? 'Paid' : 'Pending'}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <ul className="space-y-2">
                            {order.items.map((item, index) => (
                                <li key={index} className="p-2 bg-white rounded-md text-sm">{item}</li>
                            ))}
                        </ul>
                    </div>
                </div>
