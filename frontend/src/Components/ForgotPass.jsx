...
import ForgotLeft from './frogotCompo/ForgotLeft'
import ForgotRight from './frogotCompo/ForgotRight'
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative w-full max-w-4xl">
            ...
            {/* Card */}
            <div className="relative flex flex-col lg:flex-row w-full bg-white rounded-2xl shadow-xl overflow-hidden min-h-[350px] sm:min-h-[450px]">
