...
function ForgotRight() {
    ...
    const handleForgetPass = async (e) => {
        ...
        try {
            ...
            if (res.status === 200) {
                toast.update(toastId, { render: "Password reset link sent to your email.", type: "success", isLoading: false, autoClose: 3000 });
            } else {
                toast.update(toastId, { render: "Error sending password reset link. Please try again.", type: "error", isLoading: false, autoClose: 3000 });
            }
        } catch (error) {
