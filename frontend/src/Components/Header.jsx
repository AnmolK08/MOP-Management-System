...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-20 whitespace-nowrap border-b border-solid border-b-[#f4f2f0] bg-white/80 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex flex-1 items-center gap-6">
            <nav className="flex items-center gap-8">
              ...
              <a className="text-stone-700 hover:text-[#ec6d13] text-base font-medium leading-normal transition-colors" href="#">About Us</a>
